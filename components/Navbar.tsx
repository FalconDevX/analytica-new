...
const Navbar = () => {
    return (
        <div className="fixed top-0 left-0 right-0 z-50 h-16 flex items-center justify-center gap-8 sm:gap-4 backdrop-blur-lg bg-black/80 cursor-pointer">
            ...
            <div className="sm:w-1/3">
                <div className="flex flex-row items-center justify-end gap-2 pr-0 sm:pr-10 cursor-pointer">
