		...
		<div id="contact" className="appear w-full min-h-[70vh] flex flex-col items-center px-5 md:px-0">
			...
			<form onSubmit={handleSubmit} className="w-full max-w-xl flex flex-col gap-2">
				<input
					...
					className="text-black dark:text-white focus:outline-none focus:border-black dark:focus:border-white border-gray-400 border-2 rounded-none p-2"
					type="text"
				...
				<textarea
					...
					className="min-h-20 text-black dark:text-white focus:outline-none focus:border-black dark:focus:border-white border-gray-400 border-2 rounded-none p-2 resize-none "
					placeholder={t("form.message")}
				/>
				<button
					type="submit"
					className="w-full border-2 focus:outline-none focus:border-black dark:focus:border-white border-gray-400 dark:border-gray-400 text-black dark:text-white bg-white dark:bg-black px-4 py-2 transition-all duration-200 hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black hover:border-black cursor-pointer"
				>
					{t("form.send")}
				</button>
			</form>
