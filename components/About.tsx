...
const About = () => {
  return (
    <div id="about" className="appear w-full min-h-[60vh] flex flex-col items-center scroll-mt-15">
      <h1 className="text-black dark:text-white text-2xl p-6">About Us</h1>
