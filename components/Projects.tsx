		...
		<div id="projects" className="appear w-full min-h-[90vh] flex flex-col items-center justify-start scroll-mt-20">
			...
			<div className="flex flex-col md:flex-row gap-5">
				<div className="max-w-xl px-5 sm:px-0">
					...
					<p className="text-black dark:text-white text-md p-3 whitespace-pre-line">
						{t("developersChat.description")}
					</p>
				</div>
				<div className="max-w-xl px-5 sm:px-0">
					<h3 className="text-lg p-3 text-black dark:text-white">{t("tradeAnalysis.title")}</h3>
					<div className="relative w-full h-[300px] p-3" data-tilt suppressHydrationWarning>
					...
					<p className="text-md p-3 whitespace-pre-line text-black dark:text-white">{t("tradeAnalysis.description")}</p>
				</div>
			</div>
		</div>
	)
